...
# ==========================================
# پەڕەی کاشێر (هاوشێوەی فۆڕمی C# و چاپی ٨٠مم)
# ==========================================
...
<body>
    ...
    <!-- شاراوەی چاپی وەسڵ (Print Receipt 80mm) -->
    ...
    <script>
        ...
        function submitAndPrintPayment() {
            ...
            // ١. ناردنی داواکاری تەواوکردنی حیساب بۆ داتابەیس
            fetch('/admin/complete_payment', {
                ...
                if (res.status === 'success') {
                    // ٢. چاپکردنی وەسڵ لەسەر پرێنتەری کاشێر
        ...
        // Auto Refresh هەموو ٤ چرکە جارێک هاوشێوەی C#
        setInterval(() => {
